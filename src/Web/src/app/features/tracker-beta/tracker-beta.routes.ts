 ...
 * dedicated `platform.mobile` permission (code-only; no migration). The {@link OptimisticTracker} perf
 ...
 * — or equivalently a single loadComponent route guarded by permissionGuard(PERM.platformMobile).
 */
