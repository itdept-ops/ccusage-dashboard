...
export class Welcome {
  ...
  private static readonly pages: { perm: string; page: AccessiblePage }[] = [
    {
      perm: PERM.dashboardView,
      page: {
        path: '/',
        label: 'Dashboard',
        icon: 'space_dashboard',
        blurb: 'Token usage, cost and records.',
      },
    },
    {
      perm: PERM.calendarView,
      page: {
        path: '/calendar',
        label: 'Calendar',
        icon: 'calendar_month',
        blurb: 'Activity heatmap and session drill-down.',
      },
    },
    {
      perm: PERM.pricingView,
      page: { path: '/pricing', label: 'Pricing', icon: 'sell', blurb: 'Per-model rate table.' },
    },
    {
      perm: PERM.settingsView,
      page: {
        path: '/settings',
        label: 'Settings',
        icon: 'tune',
        blurb: 'Timezone, sources and sync.',
      },
    },
    {
      perm: PERM.reporterView,
      page: {
        path: '/reporter',
        label: 'Reporter',
        icon: 'cable',
        blurb: 'Ingest keys and reporter setup.',
      },
    },
    {
      perm: PERM.usersView,
      page: {
        ...
        label: 'Users',
        icon: 'group',
        blurb: 'User list and access control.',
      },
    },
    {
      perm: PERM.activityView,
      page: { path: '/activity', label: 'Activity', icon: 'monitoring', blurb: 'Request logs.' },
    },
  ];
